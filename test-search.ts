...
const CASES: Case[] = [
  ...
  // ── 逃生設施/缺失進階 ────────────────────────────────────────────────────
  { q: '集合住宅共用走道設置鐵捲門並上鎖是否影響避難逃生列為缺失',       expectId: 'WKB-501', label: '走道鐵捲門上鎖缺失' },
  { q: '建築物公共安全檢查中直通樓梯未達防火區劃應如何判定與記錄',       expectId: 'WKB-502', label: '直通樓梯防火區劃判定' },
  { q: '建築物未設置避難方向指示燈屬於公安檢查還是消防檢修範疇',         expectId: 'WKB-503', label: '避難指示燈公安vs消防' },
  { q: '地下停車場排煙設備故障在公共安全檢查中應如何評估其風險等級',      expectId: 'WKB-504', label: '地下停車場排煙設備風險' },
  { q: '公共安全申報中改善中與未改善在主管機關審查上有何差異',           expectId: 'WKB-505', label: '改善中vs未改善審查差異' },
  { q: '同一棟建築物內部分戶自行加裝鐵門是否需逐戶列入缺失',            expectId: 'WKB-506', label: '分戶加裝鐵門逐戶列缺失' },
  { q: '公共安全檢查報告照片與文字說明不一致會造成哪些申報風險',          expectId: 'WKB-507', label: '照片文字不一致申報風險' },
  { q: '檢查人未實際到場而以舊照片申報涉及哪些法規責任',                expectId: 'WKB-508', label: '未到場舊照片申報責任' },
  { q: '建築物安全梯間設置鞋櫃雜物或裝飾物應如何判定是否影響避難功能',   expectId: 'WKB-509', label: '安全梯間鞋櫃裝飾物判定' },
  { q: '申報期限內未完成送件對業主與檢查機構有何影響',                  expectId: 'WKB-510', label: '期限未送件影響' },
